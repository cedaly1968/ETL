...
for i in store_tuple:
	...
	ordercount = int(math.ceil((bigcommerce.Product_discount.get_count().count)/200.0))
	...
	for n in xrange(1,ordercount+1):
		orders = bigcommerce.Product_discount.get(n)
		for o in orders:
			d=[]      
			for c in col: 
				b=getattr(o,c) 
...
a ='/home/mjhabiger/bigcommerce/hist_data/Product_discount%s.txt' % date
...
shutil.copyfile(a,'/home/mjhabiger/bigcommerce/Product_discount.txt') 
