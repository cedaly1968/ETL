...
for i in store_tuple:
	...
	ordercount = int(math.ceil((bigcommerce.Brands.get_count().count)/200.0))
	...
	for n in xrange(1,ordercount+1):
		orders = bigcommerce.Brands.get(n)
		for o in orders:
			d=[]      
			for c in col: 
				b=getattr(o,c) 
...
a ='/home/mjhabiger/bigcommerce/hist_data/Brands%s.txt' % date
...
shutil.copyfile(a,'/home/mjhabiger/bigcommerce/Brands.txt') 
